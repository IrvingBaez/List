...
public class ListElementTest {
    ...
    public void compareToAlphabetical() {
        ListElement a = new ListElement(1,0,"A",0,0, "2020-01-01 01:01:01");
        ListElement b = new ListElement(2,0,"B",0,1, "2020-02-01 01:01:01");
    ...
    public void insertElement() {
        ListElement a = new ListElement(1,0,"A",0,0, "2020-01-01 01:01:01");
        ListElement b = new ListElement(2,0,"B",0,1, "2020-02-01 01:01:01");
        ListElement c = new ListElement(3,0,"C",0,2, "2020-03-01 01:01:01");
        ListElement d = new ListElement(4,0,"D",0,3, "2020-04-01 01:01:01");
        ListElement e = new ListElement(5,0,"E",0,4, "2020-05-01 01:01:01");
        a.addElement(b);
        a.addElement(c);
        a.addElement(d);
        a.addElement(e);
